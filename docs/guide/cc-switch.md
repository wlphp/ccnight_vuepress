...
![img](cc-switch.assets/QQ_1770616364391.png)
...
![img](cc-switch.assets/QQ_1770617046576.png)

![img](cc-switch.assets/QQ_1770617099350.png)

![img](cc-switch.assets/QQ_1770617167201.png)
...
![img](cc-switch.assets/QQ_1770617255102.png)

2.点击左上角“设置”按钮，在通用页面下拉找到 `跳过 Claude Code初次安装确认` ，务必勾选

![img](cc-switch.assets/QQ_1770617403891.png)

3.在终端运行 `claude`，看到对话界面并能正常回复即表示配置完成

![img](cc-switch.assets/QQ_1770617428949.png)
...
![img](cc-switch.assets/QQ_1770617507867.png)
...
![img](cc-switch.assets/QQ_1770617726437.png)

3.添加成功后，在主界面会看到我们配置的分组，在右侧点击“启用”按钮，显示“使用中”，则配置完成

![img](cc-switch.assets/QQ_1770617751023.png)

4.在终端运行 `codex`，看到对话界面并能正常回复即表示配置完成

![img](cc-switch.assets/QQ_1770618130373.png)
...
![img](cc-switch.assets/QQ_1770618229087.png)2.下拉模态框，找到“API Key”配置项，填入你刚才复制的ApiKey，再点击右下角“添加”按钮
...
![img](cc-switch.assets/QQ_1770618299596.png)

3.添加成功后，在主界面会看到我们配置的分组，在右侧点击“启用”按钮，显示“使用中”，则配置完成

![img](file:///C:\Users\wl\AppData\Local\Temp\QQ_1770618299596.png)

![img](cc-switch.assets/QQ_1770618347087.png)

4.在终端运行 `gemini`，看到对话界面并能正常回复即表示配置完成

![img](cc-switch.assets/QQ_1770618601311.png)